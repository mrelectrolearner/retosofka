...
Se debe modificar en el archivo "ConnectionDB.java" dentro del paquete model las variables url, user y password segun sea pertiente para conectar la aplicacion con la base de datos local.
